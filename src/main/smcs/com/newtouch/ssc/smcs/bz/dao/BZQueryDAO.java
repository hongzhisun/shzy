package com.newtouch.ssc.smcs.bz.dao;
...
@Repository
public class BZQueryDAO extends CommonDAO implements IBZQueryDAO
{
	private String getSQL(ConditionMap cdtMap, List<Object> params)
	{
		...
		strSql += " and fm.status in (1, 3, -2, -1, -5)";

		if (cdtMap.containsCondition("deptname"))
		{
			strSql += " and dept.vardescription like ?";
