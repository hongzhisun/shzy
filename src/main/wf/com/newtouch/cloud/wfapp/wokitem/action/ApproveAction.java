...
import com.newtouch.cloud.wfapp.wokitem.bp.ApproveBP;

@Controller
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@RequestMapping("/wf/workitem/approve")
public class ApproveAction
{
	@Autowired
	private ApproveBP bp;
...
/*	public String downloadExcel() throws Exception
	{
		...
		try
		{
			...
			response.setHeader("Content-disposition", "attachment; filename=bzapprove-" + df.format(new Date()) + ".xls");
