...
import com.newtouch.cloud.wfapp.wokitem.bp.TransBP;

@Controller
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@RequestMapping("/wf/workitem/trans")
...
/*	public String downloadExcel() throws Exception
	{
		...
		try
		{
			...
			response.setHeader("Content-disposition", "attachment; filename=bzatrans-" + df.format(new Date()) + ".xls");
