...
<html>
	<head>
		...
		<script type="text/javascript" src="mc/wf/formmanager/formApprove.js"></script>
	</head>
	...
	<body class="frameBody">
		...
		<div class="panelFrameTop">
			...
			<ul id="panelTopLeft" class="panelTopLeft fleft">
				<li><button id="btnApply"><i class="menuIcon icon_sq"></i><span>申请</span></button></li>
				<li><button id="btnSubmit"><i class="menuIcon icon_ty"></i><span>同意</span></button></li>
				<li><button id="btnRollback"><i class="menuIcon icon_th"></i><span>退回</span></button></li>
				<li><button id="btnTransfer"><i class="menuIcon icon_zb"></i><span>转办</span></button></li>
				<li><button id="btnTransmit"><i class="menuIcon icon_znb"></i><span>转拟办</span></button></li>
				<li><button id="btnReject"><i class="menuIcon icon_bty"></i><span>不同意</span></button></li>
		...
		<div id="panelFrameBottom" class="panelFrameBottom">
			...
			<div class="tabWrap">
				...
				<!-- 审批意见栏 -->
				<div id="tabContentApprovalOpinion" class="tab_content" style="display: block">
					<div class="panel_frame_bottom_btn_group">
						<button id="btnSubmit2" class="panel_frame_bottom_btn panel_frame_bottom_btn_orange"><span>提交申请</span></button>
						<button id="btnOpinion" class="panel_frame_bottom_btn panel_frame_bottom_btn_green"><span>习惯用语</span></button>
					</div>
					<div class="spWrap">
						<textarea id="txtCheckDesc" name=""></textarea>
					</div>
				</div>

				<!-- 审批历史栏 -->
				<div id="tabContentCheckHistory" class="tab_content">
					<!-- 审批历史列表 -->
