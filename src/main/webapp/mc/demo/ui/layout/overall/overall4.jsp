...
<html>
	<head>
		...
		<script type="text/javascript" src="mc/demo/ui/layout/overall/overall4.js"></script>
	</head>
	
	<body>
		<div class="ui-layout-north" mc-ly-split="false" mc-ly-resize="false">
			<div class="mc-title-container no-padding-bottom">
				<div class="mc-title-inner">综合布局demo4</div>
			</div>
		...
		<div class="ui-layout-center">
			<div class="ui-layout-north mc-grid-container" mc-grid="grid2" mc-ly-split="true" mc-ly-size="200" mc-ly-resize="true" >
