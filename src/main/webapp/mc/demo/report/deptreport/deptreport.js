...
initUI = function()
{
	...
	jrcv = new mc.jrcv(
	{
		...
		post_param : 							// 提交参数
		{
			 ...
			 * 必填。
			 */
			jasper : "/mc/demo/report/deptreport/deptreport.jasper",
			/**
			 * 报表标题，必填。
			 */
			title : "部门用户统计(非分页)",
	 ...
	 * 创建查询参数对话框
	 */
	$("#queryParamDialog").DeptReportQueryDialog(
	{
		dialog :
		{
			yes : function(index, $dom)
			{
				 ...
				 * 获取参数
				 */
				var param = $("#queryParamDialog").DeptReportQueryDialog("getParam");
	...
	{
		$("#queryParamDialog").DeptReportQueryDialog("open");
	});
};
