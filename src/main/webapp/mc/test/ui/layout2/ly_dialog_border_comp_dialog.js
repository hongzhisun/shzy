/**
 * 对话框布局-内嵌自适应布局(组件化)对话框
 */
(function($)
{
	$.widget("mc.LayoutDialogBorderDialog", $.mc.BaseDialog,
	{
		/**
		 * 默认初始化参数
		 */
		options :
		{
			title : "对话框布局-内嵌自适应布局(组件化)对话框",
			content_url : "mc/test/ui/layout2/ly_dialog_border_comp_dialog.html",
			height : 500,
			width : 800,
			resize : true,
			maxmin : true,
