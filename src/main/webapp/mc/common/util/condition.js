 ...
 * 基础条件对象
 */
MCloud.util.BaseCondition = function()
{
	this.hasProperty = function(key)
	{
		for (var field in this)
		{
			if ($.trim(field.toString()) === $.trim(key.toString()))
			{
				return true;
			}
		}
	...
	{
		if (! MCloud.util.StringUtil.isEmpty(value))
		{
...
BaseCondition = MCloud.util.BaseCondition;