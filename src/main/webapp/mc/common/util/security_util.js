 ...
 * 安全工具类
 */
MCloud.util.SecurityUtil = {};


/**
 * 缩写定义
 */
SecurityUtil = MCloud.util.SecurityUtil;
 ...
 * @secondKey		密钥2
 * @thirdKey		密钥3
 * @return string 	密文（加密后的字符串）
 */
MCloud.util.SecurityUtil.Encode = function(data, firstKey, secondKey, thirdKey)
{
 ...
 * @secondKey		密钥2
 * @thirdKey		密钥3
 * @return string 	明文（解密后的字符串）
 */
MCloud.util.SecurityUtil.Decode = function(data, firstKey, secondKey, thirdKey)
{
