...
<html>
	<head>
		...
		<script type="text/javascript" src="mc/sm/config/module/module_edit_dialog.js"></script>
		<script type="text/javascript" src="mc/sm/config/module/module.js"></script>
	</head>
	
	<body>
		<div class="ui-layout-north" mc-ly-split="false" mc-ly-resize="false">
			<div class="mc-title-container no-padding-bottom">
				<div class="mc-title-inner">模块维护</div>
			</div>
		...
		<div class="ui-layout-center mc-grid-container" mc-grid="gridModule">
			<table id="gridModule"></table>
		</div>

		<div id="dialogModuleEdit" style="dispaly:none;"></div>
	</body>
</html>