...
<html>
	<head>
		...
		<script type="text/javascript" src="mc/sm/safety/auth/auth_edit_dialog.js"></script>
		<script type="text/javascript" src="mc/sm/safety/auth/auth.js"></script>
	</head>
	
	<body>
		<div class="ui-layout-north" mc-ly-split="false" mc-ly-resize="false">
			<div class="mc-title-container no-padding-bottom">
				<div class="mc-title-inner">操作权限维护：请先选择一个模块</div>
			</div>
			<div class="mc-toolbar-container no-padding-top">
				<div class="mc-toolbar-inner">
					<div class="mc-form-inline">
						<span>模块：</span><input id="module" class="mc-input" style="width:200px;">
					</div>
		...
		<div class="ui-layout-center mc-grid-container" mc-grid="gridAuth">
			<table id="gridAuth"></table>
		</div>
		<div id="dialogAuthEdit" style="display:none"></div>
	</body>
</html>