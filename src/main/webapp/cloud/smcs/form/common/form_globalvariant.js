...
{
	/**
	 * 增加parent.Ext不存在的兼容处理
	 */
	if (parentHandler.Ext == undefined || parentHandler.Ext == null)
	{
...
ssc.smcs.form.common.FormGlobalVariant.get_Parent_JSP_Hidden_CheckNull = function(parentHandler, key)
{
	...
	if (parentHandler.Ext == undefined || parentHandler.Ext == null)
	{
		...
		if (dom == null)
		{
			alert("FormGlobalVariant.get_Parent_JSP_Hidden_CheckNull(" + key + ")，parent.$(#" + key +") == null");
	...
	if (dom == null)
	{
		alert("FormGlobalVariant.get_Parent_JSP_Hidden_CheckNull(" + key + ")，parent.Ext.get(key) == null");
