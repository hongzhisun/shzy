...
ssc.component.BaseListDialog = Ext.extend(ssc.component.BaseDialog,
{
	 ...
	 * 如复选，则返回record.data.xy_KeyField的字符串，逗号分隔<br>
	 * 不会查找未加载的行<br>
	 */
	 ...
	 * 如复选，则返回record.data.xy_DisplayField的字符串，逗号分隔<br>
	 * 不会查找未加载的行<br>
	 */
	 ...
	 * 如复选，则返回record.data.attrname的字符串，逗号分隔<br>
	 * 不会查找未加载的行<br>
	 */
