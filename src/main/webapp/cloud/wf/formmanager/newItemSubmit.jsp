...
<html>
	<head>
		...
		<script type="text/javascript" src="cloud/wf/formmanager/formManagerUtil.js"></script>
		<script type="text/javascript" src="cloud/wf/formmanager/newItemSubmit.js"></script>
	</head>
	<body>
		...
		<iframe id="frmFormInfo" name="frmFormInfo" height="100%" width="100%" frameborder=0 src="${pageUrl}" ></iframe>
	</body>
</html>