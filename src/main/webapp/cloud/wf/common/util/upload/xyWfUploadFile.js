...
xyUploadFileObject.prototype.create = function(htmlObject) 
{
	...
	var str = "<table style='background:transparent url(ext/resources/images/default/panel/top-bottom.png) repeat-x scroll 0 bottom; border: 0px solid #FFFFFF;cellSpacing:1px;cellPadding:1px;' border='0'>"
			...
			+ "<img style='z-index:2' src='cloud/wf/resources/images/upload/btn_addFile.gif' style='cursor:pointer;'/>";
...
xyUploadFileObject.prototype.addFile = function() 
{
	...
	cellList.innerHTML = "<input type='image' src='cloud/wf/resources/images/upload/btn_clean.gif'>";
...
{
	//-------------------------------------------
	var srcImgPic = "cloud/wf/resources/images/upload/ico_image.png";
	var srcImgVideo = "cloud/wf/resources/images/upload/ico_video.png";
	var srcImgSound = "cloud/wf/resources/images/upload/ico_sound.png";
	var srcImgArchives = "cloud/wf/resources/images/upload/ico_zip.png";
	var srcImgFile = "cloud/wf/resources/images/upload/ico_file.png";
...
{
	var srcImgProgress = "cloud/wf/resources/images/upload/pb_demoUload.gif";
